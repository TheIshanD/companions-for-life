  ...
  return (
    <Flex direction="column" bg="red.100" minH="100vh">
        ...
        <Flex direction={["column","column","row"]} justify="center"
          ...
          p={["10px","20px","40px"]}
        >
          <Flex direction={["column","column","row"]} m="auto">
            <Flex direction="column" width={["90vw","90vw","60vw"]} bg="brand.100" p="10" borderRadius={["0px","0px","25px"]} border="4px solid" borderColor="black" borderRightRadius={["0","0","0"]} borderRight={["4px solid","4px solid","none"]}>
              <Heading size="2xl" mb="2" fontWeight="900">Where Does Your Money Go?</Heading>
            ...
            <Flex direction="column" width={["90vw","90vw","30vw"]} bg="brand.500" p="10" borderRightRadius={["0px","0px","25px"]}  border="4px solid" borderColor="black" borderLeftWidth="4px" borderLeftColor="black" align="center" justify="center" borderTop={["none","none","4px solid"]}>
        ...
        p="5">
          ...
          >
            <Heading color="red.600" size="2xl" fontWeight="900">Donation Form</Heading>
            ...
            <Flex direction="column" hidden={donationPageIndex!=1}>
              <Heading size="4xl" color="green" mb="5" fontWeight="700">{Intl.NumberFormat("en-US", {style: "currency", currency: currency}).format(+totalPaymentVal())}</Heading>
